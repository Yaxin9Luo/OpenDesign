...
**Effort done**: ~22 h (items 1-6.5 + 8 + 8.5 + 8.5-fix + 8.75 — landing track now fully commercialization-ready). **Remaining**: ~5 h coding (item 7 PPTX + 11 PPTX smoke) + ~4 h docs/video (items 9, 10).
