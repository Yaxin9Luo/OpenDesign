...
def check_pydantic_roundtrip() -> None:
    ...
    print("[3/28] pydantic schema round-trip (v2)")
...
def check_svg_text_is_vector() -> None:
    print("[6/28] SVG + HTML content (vector text, contenteditable, inline fonts)")
    from .config import REPO_ROOT
...
def check_chat_session_roundtrip() -> None:
    ...
    print("[7/28] chat session save/load")
    from .config import REPO_ROOT
    from .session import (
...
def check_apply_edits_roundtrip() -> None:
    ...
    print("[9/28] apply-edits round-trip (no API)")
...
def check_landing_mode() -> None:
    ...
    """
    print("[10/28] landing mode (no API)")
    from .config import REPO_ROOT, Settings
    from .tools import ToolContext
    from .tools.composite import composite
    from .tools.propose_design_spec import propose_design_spec
...
def check_design_system_styles() -> None:
    ...
    print("[11/28] design-system styles (no API)")
    from .config import REPO_ROOT, Settings
    from .tools import ToolContext
    from .tools.composite import composite
    from .tools.propose_design_spec import propose_design_spec
...
def check_landing_with_images() -> None:
    ...
    print("[12/28] landing with images (no API)")
    from .apply_edits import apply_edits
    from .config import REPO_ROOT, Settings
    from .schema import ArtifactType
    from .tools import ToolContext
...
def check_deck_design_system_template() -> None:
    ...
    from the slide list."""
    print("[21/28] deck design system template (no API)")
    from pptx import Presentation as _Reopen
...
def check_footer_leakage() -> None:
    ...
    print("[22/28] footer leakage check (no API)")
    from pptx import Presentation as _Reopen
...
def check_callout_overlay() -> None:
    ...
    print("[23/28] callout overlay (no API)")
    from pptx import Presentation as _Reopen
    from pptx.enum.shapes import MSO_SHAPE_TYPE
...
def check_provenance_validator() -> None:
    ...
    """
    print("[24/28] provenance validator + cover authors + wide-table cap (no API)")
    from pptx import Presentation as _Reopen
...
def check_reasoning_step_roundtrip() -> None:
    ...
    """
    print("[14/28] v2 trajectory: derive metadata from agent_trace only")
    from .chat import (
...
def check_ingest_document_markdown() -> None:
    ...
    print("[15/28] ingest_document markdown (no API)")
    from .config import REPO_ROOT, Settings
    from .tools import ToolContext
...
def check_ingest_document_image() -> None:
    ...
    print("[16/28] ingest_document image (no API)")
    from .config import REPO_ROOT, Settings
    from .tools import ToolContext
    from .tools.ingest_document import ingest_document
...
def check_ingest_document_docx() -> None:
    ...
    print("[17/28] ingest_document docx (no API)")
...
def check_ingest_document_pptx() -> None:
    ...
    print("[18/28] ingest_document pptx (no API)")
...
def check_sub_figure_registration() -> None:
    ...
    """
    print("[19/28] sub-figure extraction (no API)")
    from .config import REPO_ROOT, Settings
    from .tools import ToolContext
...
def check_versioning_no_api() -> None:
    ...
    """
    print("[20/28] versioning + revise-loop preservation (no API)")
    from .config import REPO_ROOT, Settings
    from .tools import ToolContext
    from .tools.composite import composite
    from .tools.propose_design_spec import propose_design_spec
...
def check_critic_subagent_trajectory() -> None:
    ...
    print("[25/28] critic sub-agent: scripted report_verdict + trajectory written")
...
def check_critic_subagent_max_turns() -> None:
    ...
    print("[26/28] critic sub-agent: max_turns failsafe → fail verdict")
    from .agents import CriticAgent
    from .schema import ArtifactType
...
def check_critic_planner_consumption() -> None:
    ...
    """
    print("[27/28] planner consumption: pass/revise/fail routing")
    from .agents import CriticAgent
    from .config import REPO_ROOT
...
def check_critic_subagent_png_throughput() -> None:
    ...
    print("[28/28] critic sub-agent: 15-slide PNG throughput (no OOM)")
    from .agents import CriticAgent
    from .schema import ArtifactType
